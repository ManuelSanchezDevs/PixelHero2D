...
public class PlayerController : MonoBehaviour
{
    ...
    private bool isGrounded,isFlippedX;
    ...
    private void Shoot()
    {
        ...
        {
            ArrowController tempArrowController = Instantiate
                (arrowController, transformArrowPoint.position, transformArrowPoint.rotation);
        ...
        if ((Input.GetButtonDown("Fire2") && ballPlayer.activeSelf) && playerExtrasTracker.CanDropBombs)
    ...
    private void Jump()
    {
        ...
        if (Input.GetButtonDown("Fire1") && (isGrounded || (canDoubleJump && playerExtrasTracker.CanDoubleJump)))
        {
            if (isGrounded)
            {
                canDoubleJump = true;
    ...
    private void CheckAndSetDirecction()
    {
    ...
    private void ShowAfterImage()
    {
        ...
        afterImage.transform.localScale = playerRB.transform.localScale;
